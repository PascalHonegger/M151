...
<div id="content">
    ...
    <form onsubmit="applySettings(); return false;" id="settingsForm">
        <div id="settingsLeft">
            ...
            <input type="text" id="Surname" name="Surname" class="ContentInput" required="required"
                   value="<?= $user['surname'] ?>"> <br/>

            <label for="Mail" class="SettingsLabel">E-Mail</label> <br/>
            <input type="email" id="Mail" name="Mail" class="ContentInput" required="required"
                   value="<?= $user['mail'] ?>"> <br/>
        </div>

        <div id="settingsRight">
            <label for="Password" class="SettingsLabel">Passwort (Leer => Passwort behalten)</label> <br/>
            <input type="password" id="Password" name="Password" class="ContentInput"><br/>

            <label for="RepPassword" class="SettingsLabel">Passwort Wiederholen</label> <br/>
            <input type="password" id="RepPassword" name="RepPassword" class="ContentInput"> <br/>
