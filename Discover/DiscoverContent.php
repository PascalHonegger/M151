...
<div id="LoginContent">
    ...
    <form onsubmit="return register()" id="registerform">
        ...
        <input type="text" id="RegisterUsername" name="RegisterUsername" class="RegisterInput" required="required">
        <br/>
        ...
        <input type="password" id="RegisterPassword" name="RegisterPassword" class="RegisterInput" required="required">
        <br/>
